...
public TestCrapsControlFrame(String title)
{
 super( title );
 ...
 crapsPanel = new JPanel( new FlowLayout() );
...
// soundPanel.setSize(200, 200);
 ...
 aboutItem.addActionListener(
   new ActionListener()  // Beginning of anonymous inner class
   {
     public void actionPerformed( ActionEvent event )
     {
         ...
         validate();
         repaint();
     	JOptionPane.showMessageDialog( TestCrapsControlFrame.this,
                                   "Assignment Week 08 \n"
                                   + "This application is a crap game \n"
                                   + "of Craps.",
 ...
 JMenuItem crapsPanelItem = new JMenuItem( "Craps Game Play" );
 crapsPanelItem.setMnemonic( 'C' );
 crapsPanelItem.setToolTipText("Time to play craps");
...
//         JOptionPane.showMessageDialog( TestCrapsControlFrame.this, "You must enter a valid number and then <ENTER> for each textbox!", "Invalid Input", JOptionPane.ERROR_MESSAGE );
//         e.printStackTrace();
//       }
//     }
//   }
// );
 ...
 crapsRollJButton = new JButton( "Roll Dice" );   
 crapsRollJButton.addActionListener(
   new ActionListener()
   {
     public void actionPerformed( ActionEvent event )
     {
...
// calcPanel.add( calcJButton );
 ...
 crapsPanel.add( crapsRollJButton );
